...
#Variant calling
$location/samtools1/samtools mpileup  -B -t DP,ADF,ADR $realignments -C50 -uf $f0/$my_gs $f1/alignment1.bam 2> $f2/mpileup_problem-sample_std.txt | $location/bcftools-1.3.1/bcftools call -mv -Ov > $f1/raw_variants.vcf 2> $f2/call_problem-sample_std.txt
